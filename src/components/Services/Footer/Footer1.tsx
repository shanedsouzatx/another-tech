    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        <div className="text-center sm:text-left">
          <p className="text-xl font-medium  bg-gradient-to-t from-[#48128A] to-[#8B3791] text-transparent bg-clip-text">About Us</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-xl font-medium  bg-gradient-to-t from-[#48128A] to-[#8B3791] text-transparent bg-clip-text">Our Services</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-xl font-medium  bg-gradient-to-t from-[#48128A] to-[#8B3791] text-transparent bg-clip-text">Helpful Links</p>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            ...
            <li>
              <a
                className="group flex justify-center -ml-11 ltr:sm:justify-start rtl:sm:justify-end"
                href="#"
              >
                <span
        ...
        <div className="text-center sm:text-left">
          <p className="text-xl font-medium  bg-gradient-to-t from-[#48128A] to-[#8B3791] text-transparent bg-clip-text">Contact Us</p>
...
&nbsp;
          <a
            className="inline-block text-[#48128A] underline transition hover:text-[#8B3791] dark:text-teal-500 dark:hover:text-teal-500/75"
            href="#"
          >
            Terms & Conditions
          </a>
